...
export const FeedbackButton: React.FC<FeedbackButtonProps> = ({ className = '' }) => {
  ...
  return (
    <>
      {/* Feedback trigger — pinned to the viewport corner so it stays visible
          and travels with you as you scroll through the page. */}
      <div className={`fixed bottom-4 right-4 z-40 ${className}`}>
        <button
          onClick={() => setIsOpen(true)}
          className="btn3d btn3d--primary px-4 py-2.5 text-sm"
