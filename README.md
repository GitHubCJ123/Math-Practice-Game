...
| Layer | Technology |
|---|---|
| **Frontend** | [React 19](https://react.dev), [TypeScript 6](https://www.typescriptlang.org), [Vite 8](https://vitejs.dev), [React Router 7](https://reactrouter.com), [Tailwind CSS 3.4](https://tailwindcss.com) (PostCSS build) |
